            ...
            if (CheckFieldsLoginPane()) {
                ...
                if (ChooseRoleComboBoxLoginPane.getSelectionModel().getSelectedItem() == "خریدار") {
                    ...
                    try {
                        ...
                        result1 = statement1.executeQuery("SELECT * FROM seller  WHERE Username = '" + UsenameTextFieldLoginPane.getText() + "' AND Password='" + PasswordfTextFieldLoginPane.getText() + "'");
                        if (result.next() && result1.next()) {
                    ...
                    if (ChooseRoleComboBox.getSelectionModel().getSelectedItem()=="خریدار") {
                        ...
                        if (result1.next() || result.next()){
                            ...
                            if (matcher.matches()) {
                                ...
                                statement.executeUpdate("INSERT INTO costumer (Username,Password,FirstName,LastName,PhoneNumber,EmailAddress,cart,wallet,discountcode) VALUES ('" + UsernameTextField.getText() + "','" + PasswordTextField.getText() + "','" + NameTextField.getText() + "','"+FamilyTextField.getText()+"','"+PhoneNumberTextField.getText()+"','"+EmailTextField.getText()+"','0','0','0')");
                                alert = new Alert(Alert.AlertType.INFORMATION);
                    ...
                    if (ChooseRoleComboBox.getSelectionModel().getSelectedItem()=="فروشنده") {
                        ...
                        if (result.next() || result1.next()){
                            ...
                            if (matcher.matches()) {
                                //Todo Account Successfully Created
                                System.out.println("Valid email address");
                                statement.executeUpdate("INSERT INTO seller (Username,Password,FirstName,LastName,PhoneNumber,EmailAddress,Company) VALUES ('" + UsernameTextField.getText() + "','" + PasswordTextField.getText() + "','" + NameTextField.getText() + "','"+FamilyTextField.getText()+"','"+PhoneNumberTextField.getText()+"','"+EmailTextField.getText()+"','mohammad')");
                                alert = new Alert(Alert.AlertType.INFORMATION);
                                alert.setTitle("Information Message");
                                alert.setHeaderText(null);
                                alert.setContentText("Account Successfully Created");
